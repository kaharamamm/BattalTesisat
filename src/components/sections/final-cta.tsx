        ...
        <Reveal>
          <div className="rounded-2xl bg-navy px-6 py-12 text-center text-white md:px-12 md:py-16">
            <h2 className="mx-auto max-w-3xl text-2xl text-balance text-white sm:text-3xl lg:text-4xl">
              Tesisat ihtiyacınız için Battal Tesisat ile iletişime geçin.
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-sm text-white/70 sm:text-base">
              WhatsApp veya telefon üzerinden bize ulaşabilirsiniz. Detaylı
              iletişim bilgileri müşteri onayından sonra güncellenecektir.
            </p>
